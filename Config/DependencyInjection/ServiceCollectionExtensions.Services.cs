...
public static partial class ServiceCollectionExtensions
{
    private static IServiceCollection AddDomainServices(this IServiceCollection services)
    {
        ...
        services.AddScoped<TestPreparationService>();
        ...
        services.AddScoped<IArchiveRegisterSimulationService, ArchiveRegisterSimulationService>();
        services.AddScoped<ArchiveFilingElectronicSubmissionRequestBuilder>();
        services.AddScoped<ArchiveRegisterComplexElectronicApplicationOrchestrator>();
