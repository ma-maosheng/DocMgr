        ...
        return new List<FieldDomainSeed>
            {
                ...
                new(
                    ...
                    new List<FieldDomainOptionSeed>
                    {
                        new(string.Empty, ArchiveRegisterDomainValues.SimulatedMaterialCategoryText, ArchiveRegisterDomainValues.SimulatedMaterialCategoryText, true, 10),
                        new(string.Empty, ArchiveRegisterDomainValues.SimulatedMaterialCategoryMap, ArchiveRegisterDomainValues.SimulatedMaterialCategoryMap, true, 20),
                    }),
                new(
                    nameof(YearlyArchiveRegisterSimulatedMediaItemDetail),
                    nameof(YearlyArchiveRegisterSimulatedMediaItemDetail.SubCategory),
                    "所属子类",
                    "模拟资料子项所属子类，按资料类型区分作用域。",
                    true,
                    23,
                    new List<FieldDomainOptionSeed>
                    {
                ...
                new(
                    ...
                    new List<FieldDomainOptionSeed>
                    {
                        new(string.Empty, ArchiveRegisterDomainValues.SimulatedOrganizationFormLoose, ArchiveRegisterDomainValues.SimulatedOrganizationFormLoose, true, 10),
                        new(string.Empty, ArchiveRegisterDomainValues.SimulatedOrganizationFormBound, ArchiveRegisterDomainValues.SimulatedOrganizationFormBound, true, 20),
                    }),
                new(
                    "YearlyArchiveRegisterMedia",
                    "MediaType",
