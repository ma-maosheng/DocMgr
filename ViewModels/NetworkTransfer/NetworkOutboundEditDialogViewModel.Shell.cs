...
/// <summary>
/// 出网编辑弹窗：对接 <see cref="Views.Shared.ApprovalHandoverWorkspaceShell"/> 的契约别名。
/// </summary>
public sealed partial class NetworkOutboundEditDialogViewModel
{
    /// <summary>壳：顶部流程横幅（对标 RegisterWorkspaceBannerText）。</summary>
    ...
    public string PhotoZoneHint => "出网业务无需上传资料照片。";
    ...
    /// <summary>壳：上传照片（出网不启用）。</summary>
    public ICommand? UploadPhotoCommand => null;

    /// <summary>壳：高影仪照片（出网不启用）。</summary>
