...
{
    /// <summary>
    /// 在网数据处置窗：对接 <see cref="Views.Shared.ApprovalHandoverWorkspaceShell"/> 的契约别名。
    /// </summary>
    public partial class NetworkOnNetDisposalEditDialogViewModel
    {
        public string BannerText =>
            "在网数据处置：选择在网对象并填写处置原因/方式。流程：保存草稿 → 提交 → 打印签批单并线下签字 → 审批通过 → 确认可上传 → 分区上传签批单 → 确认办结。";
        ...
        public string PhotoZoneHint => "在网处置无需上传资料照片。";
