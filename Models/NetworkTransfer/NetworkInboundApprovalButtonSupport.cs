...
/// <summary>
/// 入网申请审批弹窗五按钮规则（委托统一 <see cref="ApprovalWorkflowButtonSupport"/>）。
/// </summary>
public static class NetworkInboundApprovalButtonSupport
{
        ...
        bool attachmentsMeetMandatoryRequirements)
    {
        ...
        if (record.Status == NetworkInboundRecord.StatusApproved)
        {
